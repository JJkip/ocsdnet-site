...
<!--<aside id="sidebar" role="complementary" class="<?php do_action( 'sidebar_class' ); ?>">-->
	<aside id="sidebar" role="complementary" class="column six sidebar-left">
	<!-- sidebar -->
		<?php
        	...
        	<h3><?php echo infinity_option_get( 'top_goal_sidebar_header' ); ?></h3>
            <h4><?php echo infinity_option_get( 'top_goal_sidebar_title' ); ?></h4>
            <div class="summary"><?php echo infinity_option_get( 'top_goal_sidebar_content' ); ?></p>
			<p><a title="OCSDNet goals" href="<?php echo infinity_option_get( 'top_goal_sidebar_readmore_link' ); ?>"><strong><?php echo infinity_option_get( 'top_goal_sidebar_readmore' ); ?></strong></a></div>

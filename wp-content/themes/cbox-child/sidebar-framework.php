...
<aside id="sidebar" role="complementary" class="<?php do_action( 'sidebar_class' ); ?>">
	...
	<!-- sidebar -->
		<?php
        	...
        	<h3><?php echo infinity_option_get( 'framework_sidebar_header' ); ?></h3>
            <h4><?php echo infinity_option_get( 'framework_sidebar_title' ); ?></h4>
            <div class="summary"><?php echo infinity_option_get( 'framework_sidebar_content' ); ?></p>
			<p><a title="OCSDNet goals" href="<?php echo infinity_option_get( 'framework_sidebar_readmore_link' ); ?>"><strong><?php echo infinity_option_get( 'framework_sidebar_readmore' ); ?></strong></a></div>
			...
			<li><a title="Download Documents" href="<?php echo infinity_option_get( 'framework_sidebar_document_download_link' ); ?>"><?php echo infinity_option_get( 'framework_document_download' ); ?></a></li>
			</ul>
			</div>
        </section>

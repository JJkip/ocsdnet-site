                                                            ...
                                                            <div class="bg-overlay"></div>
                                                                ...
                                                                <div class="content">                              										
                                                                    ...
                                                                    <a href="<?php echo get_the_permalink(); ?>">
                                                                    	...
                                                                    	<h4><?php echo break_the_title(); ?></h4>
																										  			    
														  			    <p>
																			<?php  echo break_the_title(get_the_excerpt(), 23); ?>						 
																		</p>
				...
				<div class="row">
								...
								<div class="panel-body">
									<ul class="list-inline all-events">
										...
										<?php while($events->have_posts()): $events->the_post(); ?>
											...
											<?php $start_date_numc = get_post_meta(get_the_ID(), '_event_start_date', true); ?>
											<?php $end_date_numc = get_post_meta(get_the_ID(), '_event_end_date', true); ?>

											<?php $start_date = date_parse($start_date_numc); ?>
											<?php $end_date =  date_parse($end_date_numc); ?>
										...
										<?php sort_em_events_by_date($events_arr); ?>

										<?php for($i=0; $l = count($events_arr), $i<$l; $i++): ?>

											<?php $event = $events_arr[$i]; ?>

											<li>
												<a href="<?php echo get_the_permalink(); ?>" title="<?php echo $event['name']; ?>">
												<div class="event-month pull-left">
													<h4><?php echo date('F', mktime(0, 0, 0, $event['month'], $event['day'], $event['year'])); ?></h4>
													<p>
														<?php echo $event['day']; ?>-<?php echo $event['end_day']; ?>
													</p>
												</div>
												<div class="event-title pull-right">
													<p>
											  			 <?php echo ucwords(strtolower(break_the_title($event['name']))); ?>
													</p>
												</div></a>
											</li>
									       <?php if($i < $l-1): ?> <hr /> <?php endif; ?>
									   <?php endfor; ?>
								</div>
								<div class="panel-footer more-events">
									<a href="<?php bloginfo('url'); ?>/events/" title="See all OCSDNET Events"> <i class="fa fa-eye"></i>&nbsp;view more</a>
								</div>
							<?php else: ?>
					...
					<?php 
						$grant_Winners = new WP_Query(array(
							'post_type'=>'grantwinnersarticles',
							'posts_per_page'=>4,
                            'orderby'=>'date',
                            'order'=>'DESC'
						)); 
					...
					<div class="col-md-4">
						<div class="panel panel-default panel-articles">
								...
								<?php if($grant_Winners->have_posts()): ?>
									<div class="grant-winners">
										...
										<ul class="list-inline grant-winner">
											<?php $i=0; while($grant_Winners->have_posts()): $grant_Winners->the_post(); ?>
												<li>
												    ...
												    <a href="<?php echo get_the_permalink(); ?>" title="<?php echo $title; ?>">
														...
														<div class="grant-winner-article pull-right">
															  <p>
												  				    <?php echo ucwords(strtolower(break_the_title($title))); ?>
															  </p>
															<!--p>
										  		...
										  		<?php if($i < $grant_Winners->post_count-1): ?> <hr /> <?php endif; ?>
							...
							<div class="panel-footer more-articles">
								<a href="<?php bloginfo('url'); ?>/grantwinnersarticles/" title="See More from Grant Winners"> <i class="fa fa-eye"></i>&nbsp;view more</a>
							</div>
						</div>
					</div>
					...
					<div class="col-md-4">
						<div class="panel panel-default panel-forum">
							<div class="panel-heading">
								...
								<h3 class="panel-title">RECENT FROM BLOG</h3>
							</div>
							<?php if($recent_Blog->have_posts()): ?>
                                <div class="panel-body blog-posts">
									<ul class="list-inline forum-list">
										<?php $i=0; while($recent_Blog->have_posts()): $recent_Blog->the_post(); ?>
		                                       ...
		                                       <li>
													<a href="<?php echo get_the_permalink(); ?>" title="<?php echo get_the_title(); ?>" >
														<div class="blog-post-date pull-left">
															...
															<h4><?php echo date('F', mktime(0, 0, 0, $date['month'], $date['day'], $date['year'])); ?></h4>
															<p>
																<?php echo ordinate_date($date['day']); ?>
															</p>
														
														</div>
													
														<div class="blog-post-article pull-right">
															  <p>
												  			 		<?php echo ucwords(strtolower(break_the_title(get_the_title()))); ?>
															  </p>
														</div>
													</a>
											    </li>
										 
										  <?php if($i < $recent_Blog->post_count-1): ?> <hr /> <?php endif; ?>
							...
							<div class="panel-footer more-forum">
								<a href="<?php bloginfo('url'); ?>/ocsdnet-blog/" title="See more from the OCSDNET Blog"> 
								...
								<form action="//ocsdnet.us9.list-manage.com/subscribe/post?u=2573d55cb1c95710c47d40efe&amp;id=36369b552b" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
									<div class="col-md-6">
										...
										<div style="position: absolute; left: -5000px;">
											<input type="text" name="b_2573d55cb1c95710c47d40efe_36369b552b" tabindex="-1" value="">
										</div>
									</div>
									<div class="col-md-4">

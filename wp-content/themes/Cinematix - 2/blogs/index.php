...
get_header( 'buddypress' ); ?>
	...
	<?php do_action( 'bp_before_directory_blogs_page' ); ?>
		...
		<form action="" method="post" id="blogs-directory-form" class="dir-form">
			...
			<?php if ( is_user_logged_in() && bp_blog_signup_enabled() ) : ?> &nbsp;<a class="color-button" id="create-a-site" href="<?php echo bp_get_root_domain() . '/' . bp_get_blogs_root_slug() . '/create/' ?>"><?php _e( 'Create a Site', 'buddypress' ); ?></a><?php endif; ?>

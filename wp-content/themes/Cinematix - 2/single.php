...
?>
		<div class="entry">
			<?php the_content( __( 'Read the rest of this entry &rarr;', 'Cinematix' ) ); ?>
    ...
    <div id="relatedposts"><div id="relatedposts-title"><?php _e('Related Posts', 'Cinematix') ?>:</div>
	...
	<div class="clear"> </div>
			...
			<?php endwhile; else: ?>
				...
				<p><?php _e( 'Sorry, no posts matched your criteria.', 'Cinematix' ); ?></p>

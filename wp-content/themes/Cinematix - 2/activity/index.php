...
get_header( 'buddypress' ); ?>
	...
	<div class="page-title-bold"><?php the_title(); ?></div>
		...
		<div class="padder">
			...
			<div class="activity-pg-desc"><?php _e('You can browse all activities here. Use menu below if you want to browse only specific activities like Group Memberships, New Topics, New Members ...', 'Cinematix'); ?></div>
